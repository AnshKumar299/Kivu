...
const NavBar = () => {
  ...
  return (
    <>
      <nav 
        className={`bg-gradient-to-r from-amber-950 via-amber-900 to-amber-950 w-full transition-all duration-300 shadow-lg relative z-30 ${
      ...
      {/* Background Overlay for Mobile Menu - moved outside nav */}
      {showMenu && (
        <div 
